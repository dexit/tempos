...
/**
 * This class defines the structure of the 'Room_has_Activity' table.
 *
 *
 ...
 */
class RoomHasActivityTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.RoomHasActivityTableMap';
	...
	{
	  // attributes
		$this->setName('Room_has_Activity');
		$this->setPhpName('RoomHasActivity');
		$this->setClassname('RoomHasActivity');
