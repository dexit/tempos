...
/**
 * Base class that represents a row from the 'Room_has_Activity' table.
 *
 * 
 *
 ...
 */
abstract class BaseRoomHasActivity extends BaseObject  implements Persistent {


  const PEER = 'RoomHasActivityPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        RoomHasActivityPeer
	 */
	...
	/**
	 * Initializes internal state of BaseRoomHasActivity object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     RoomHasActivity The current object (for fluent API support)
	 */
	public function setRoomId($v)
	{
		...
		if ($this->room_id !== $v) {
			$this->room_id = $v;
			$this->modifiedColumns[] = RoomHasActivityPeer::ROOM_ID;
		}
	...
	public function setActivityId($v)
	{
		...
		if ($this->activity_id !== $v) {
			$this->activity_id = $v;
			$this->modifiedColumns[] = RoomHasActivityPeer::ACTIVITY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = RoomHasActivityPeer::NUM_COLUMNS - RoomHasActivityPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RoomHasActivity object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RoomHasActivityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseRoomHasActivity:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			RoomHasActivityPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseRoomHasActivity:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseRoomHasActivity:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseRoomHasActivity:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			RoomHasActivityPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RoomHasActivityPeer::doInsert($this, $con);
					...
					$affectedRows += RoomHasActivityPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RoomHasActivityPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RoomHasActivityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RoomHasActivityPeer::ROOM_ID)) $criteria->add(RoomHasActivityPeer::ROOM_ID, $this->room_id);
		if ($this->isColumnModified(RoomHasActivityPeer::ACTIVITY_ID)) $criteria->add(RoomHasActivityPeer::ACTIVITY_ID, $this->activity_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RoomHasActivityPeer::ROOM_ID, $this->room_id);
		$criteria->add(RoomHasActivityPeer::ACTIVITY_ID, $this->activity_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RoomHasActivity (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RoomHasActivity Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RoomHasActivityPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RoomHasActivityPeer();
		}
		return self::$peer;
	}
	...
	public function getRoom(PropelPDO $con = null)
	{
		if ($this->aRoom === null && ($this->room_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aRoom->addRoomHasActivitys($this);
			 */
		}
		return $this->aRoom;
	}
	...
	public function getActivity(PropelPDO $con = null)
	{
		if ($this->aActivity === null && ($this->activity_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aActivity->addRoomHasActivitys($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseRoomHasActivity:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseRoomHasActivity::%s', $method));
    }
