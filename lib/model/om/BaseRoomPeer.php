...
abstract class BaseRoomPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Capacity', 'Address', 'Description', 'IsActive', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'capacity', 'address', 'description', 'isActive', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CAPACITY, self::ADDRESS, self::DESCRIPTION, self::IS_ACTIVE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'capacity', 'address', 'description', 'is_active', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Capacity' => 2, 'Address' => 3, 'Description' => 4, 'IsActive' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'capacity' => 2, 'address' => 3, 'description' => 4, 'isActive' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CAPACITY => 2, self::ADDRESS => 3, self::DESCRIPTION => 4, self::IS_ACTIVE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'capacity' => 2, 'address' => 3, 'description' => 4, 'is_active' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RoomPeer::CAPACITY);

		$criteria->addSelectColumn(RoomPeer::ADDRESS);

		$criteria->addSelectColumn(RoomPeer::DESCRIPTION);

		$criteria->addSelectColumn(RoomPeer::IS_ACTIVE);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += RoomPeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in CloseperiodPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			CloseperiodPeer::clearInstancePool();

			// invalidate objects in DayperiodPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			DayperiodPeer::clearInstancePool();

			// invalidate objects in RoomprofilePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
