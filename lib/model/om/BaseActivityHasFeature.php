...
/**
 * Base class that represents a row from the 'Activity_has_Feature' table.
 *
 * 
 *
 ...
 */
abstract class BaseActivityHasFeature extends BaseObject  implements Persistent {


  const PEER = 'ActivityHasFeaturePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ActivityHasFeaturePeer
	 */
	...
	/**
	 * Initializes internal state of BaseActivityHasFeature object.
	 * @see        applyDefaults()
	 */
	...
	public function setActivityId($v)
	{
		...
		if ($this->activity_id !== $v) {
			$this->activity_id = $v;
			$this->modifiedColumns[] = ActivityHasFeaturePeer::ACTIVITY_ID;
		}
	...
	public function setFeatureId($v)
	{
		...
		if ($this->feature_id !== $v) {
			$this->feature_id = $v;
			$this->modifiedColumns[] = ActivityHasFeaturePeer::FEATURE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ActivityHasFeaturePeer::NUM_COLUMNS - ActivityHasFeaturePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ActivityHasFeature object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ActivityHasFeaturePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseActivityHasFeature:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			ActivityHasFeaturePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseActivityHasFeature:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseActivityHasFeature:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseActivityHasFeature:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ActivityHasFeaturePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ActivityHasFeaturePeer::doInsert($this, $con);
					...
					$affectedRows += ActivityHasFeaturePeer::doUpdate($this, $con);
				}
	...
	{
		$pos = ActivityHasFeaturePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ActivityHasFeaturePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActivityHasFeaturePeer::ACTIVITY_ID)) $criteria->add(ActivityHasFeaturePeer::ACTIVITY_ID, $this->activity_id);
		if ($this->isColumnModified(ActivityHasFeaturePeer::FEATURE_ID)) $criteria->add(ActivityHasFeaturePeer::FEATURE_ID, $this->feature_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ActivityHasFeaturePeer::ACTIVITY_ID, $this->activity_id);
		$criteria->add(ActivityHasFeaturePeer::FEATURE_ID, $this->feature_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ActivityHasFeature (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ActivityHasFeature Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ActivityHasFeaturePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ActivityHasFeaturePeer();
		}
		return self::$peer;
	}
	...
	public function getFeature(PropelPDO $con = null)
	{
		if ($this->aFeature === null && ($this->feature_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aFeature->addActivityHasFeatures($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseActivityHasFeature:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseActivityHasFeature::%s', $method));
    }
