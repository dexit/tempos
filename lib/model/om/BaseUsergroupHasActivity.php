...
/**
 * Base class that represents a row from the 'UserGroup_has_Activity' table.
 *
 * 
 *
 ...
 */
abstract class BaseUsergroupHasActivity extends BaseObject  implements Persistent {


  const PEER = 'UsergroupHasActivityPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        UsergroupHasActivityPeer
	 */
	...
	/**
	 * Initializes internal state of BaseUsergroupHasActivity object.
	 * @see        applyDefaults()
	 */
	...
	public function setUsergroupId($v)
	{
		...
		if ($this->usergroup_id !== $v) {
			$this->usergroup_id = $v;
			$this->modifiedColumns[] = UsergroupHasActivityPeer::USERGROUP_ID;
		}
	...
	public function setActivityId($v)
	{
		...
		if ($this->activity_id !== $v) {
			$this->activity_id = $v;
			$this->modifiedColumns[] = UsergroupHasActivityPeer::ACTIVITY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->usergroup_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = UsergroupHasActivityPeer::NUM_COLUMNS - UsergroupHasActivityPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating UsergroupHasActivity object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UsergroupHasActivityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseUsergroupHasActivity:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			UsergroupHasActivityPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseUsergroupHasActivity:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseUsergroupHasActivity:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseUsergroupHasActivity:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			UsergroupHasActivityPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UsergroupHasActivityPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UsergroupHasActivityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = UsergroupHasActivityPeer::getFieldNames($keyType);
		$result = array(
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setUsergroupId($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsergroupHasActivityPeer::USERGROUP_ID)) $criteria->add(UsergroupHasActivityPeer::USERGROUP_ID, $this->usergroup_id);
		if ($this->isColumnModified(UsergroupHasActivityPeer::ACTIVITY_ID)) $criteria->add(UsergroupHasActivityPeer::ACTIVITY_ID, $this->activity_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UsergroupHasActivityPeer::USERGROUP_ID, $this->usergroup_id);
		$criteria->add(UsergroupHasActivityPeer::ACTIVITY_ID, $this->activity_id);
	...
	public function getPrimaryKey()
	{
		...
		$pks[0] = $this->getUsergroupId();

		$pks[1] = $this->getActivityId();
	...
	public function setPrimaryKey($keys)
	{
		...
		$this->setUsergroupId($keys[0]);

		$this->setActivityId($keys[1]);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsergroupHasActivity (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UsergroupHasActivity Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UsergroupHasActivityPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UsergroupHasActivityPeer();
		}
		return self::$peer;
	}
	...
	public function getUsergroup(PropelPDO $con = null)
	{
		if ($this->aUsergroup === null && ($this->usergroup_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsergroup->addUsergroupHasActivitys($this);
			 */
		}
	...
	public function getActivity(PropelPDO $con = null)
	{
		if ($this->aActivity === null && ($this->activity_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aActivity->addUsergroupHasActivitys($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseUsergroupHasActivity:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseUsergroupHasActivity::%s', $method));
    }
