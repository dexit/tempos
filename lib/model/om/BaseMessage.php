...
abstract class BaseMessage extends BaseObject  implements Persistent {
  ...
  const PEER = 'MessagePeer';
	...
	/**
	 * The value for the was_read field.
	...
	/**
	 * Set the value of [was_read] column.
	 * 
	 * @param      int $v new value
	 * @return     Message The current object (for fluent API support)
	 */
	public function setWasRead($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->was_read !== $v || $v === 0) {
			$this->was_read = $v;
			$this->modifiedColumns[] = MessagePeer::WAS_READ;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(MessagePeer::WAS_READ))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->sender = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->sender_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->was_read = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUserRelatedBySenderId !== null && $this->sender_id !== $this->aUserRelatedBySenderId->getId()) {
			$this->aUserRelatedBySenderId = null;
		}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getSender(),
			$keys[6] => $this->getSenderId(),
			$keys[7] => $this->getWasRead(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setSender($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setSenderId($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setWasRead($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessagePeer::WAS_READ)) $criteria->add(MessagePeer::WAS_READ, $this->was_read);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setWasRead($this->was_read);
	...
	public function setUserRelatedByRecipientId(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addMessageRelatedByRecipientId($this);
		}
	...
	public function getUserRelatedByRecipientId(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByRecipientId === null && ($this->recipient_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUserRelatedByRecipientId->addMessagesRelatedByRecipientId($this);
			 */
		}
	 ...
	 * @throws     PropelException
	 */
	public function setUserRelatedBySenderId(User $v = null)
	{
		if ($v === null) {
	 ...
	 * @throws     PropelException
	 */
	public function getUserRelatedBySenderId(PropelPDO $con = null)
	{
		if ($this->aUserRelatedBySenderId === null && ($this->sender_id !== null)) {
			$c = new Criteria(UserPeer::DATABASE_NAME);
			$c->add(UserPeer::ID, $this->sender_id);
			$this->aUserRelatedBySenderId = UserPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUserRelatedBySenderId->addMessagesRelatedBySenderId($this);
			 */
		}
	...
	public function setUserRelatedByOwnerId(User $v = null)
	{
		...
		// If this object has already been added to the User object, it will not be re-added.
		if ($v !== null) {
			$v->addMessageRelatedByOwnerId($this);
		}
	...
	public function getUserRelatedByOwnerId(PropelPDO $con = null)
	{
		if ($this->aUserRelatedByOwnerId === null && ($this->owner_id !== null)) {
			...
			$this->aUserRelatedByOwnerId = UserPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUserRelatedByOwnerId->addMessagesRelatedByOwnerId($this);
			 */
		}
